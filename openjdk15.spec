...
# Source0-md5:	6024e4f52614c602d738668f1c0393ba
...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk15-jdk < 15.0.10-3
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk15-jdk-base < 15.0.10-3
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk15-jre < 15.0.10-3
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk15-jre-base < 15.0.10-3
...
Obsoletes:	openjdk15-jre-base-X11 < 15.0.10-3
...
Obsoletes:	openjdk15-jre-base-freetype < 15.0.10-3
...
Obsoletes:	jar
Obsoletes:	openjdk15-jar < 15.0.10-3
